export const LangJa = {
    ...
    home:{
        ...
        tooltip:{
            doll: {
                outerwear: "アウトフィットの!~SLOT~!スロットをアウターウェア状態に設定します。<br><br>コマンド：@!~STATE~! !~SLOT~!",
                underwear: "アウトフィットの!~SLOT~!スロットをアンダーウェア状態に設定します。<br><br>コマンド：@!~STATE~! !~SLOT~!",
                nude:      "アウトフィットの!~SLOT~!スロットをヌード状態に設定します。<br><br>コマンド：@!~STATE~! !~SLOT~!",
            ...
            outfitOuterwear: "アウトフィットの状態をアウターウェアに設定します。<br><br>コマンド：@o （スロット名）",
            outfitUnderwear: "アウトフィットの状態をアンダーウェアに設定します。<br><br>コマンド：@u （スロット名）",
            outfitNude:      "アウトフィットの状態をヌードに設定します。<br><br>コマンド：@n （スロット名）<br><br>指のはさみアイコンは、性器のないヌードのアウトフィットとして設定します。<br><br>コマンド：@nc",
    ...
    outfit:{
        ...
        tooltip:{
            ...
            outfitType: "アウトフィット種別を選択します。<br><br>詳細：アウトフィットスロットと３つの状態をすべて使用します。<br><br>基本：詳細と似ていますが、アウトフィットスロットを使用する必要はありません。<br><br>簡易：アウターウェアの状態のみを使用します。これは、簡単な装着または取り外しです。",
            linkMode: "アウトフィットのリンクモードを選択します。リンクされたスロットは一緒に接続および切断されます。<br><br>なし：アウトフィットをリンクしません。<br><br>胴＆股：胴と股のみをリンクします。<br><br>胴＆股＆腰：胴、股、腰をリンクします。",
            genitalsCrotch: "アウトフィットの状態に応じて、プロファイル内のgenitalsCrotchフォルダを装着または取り外します。",
            genitalsTorso: "アウトフィットの状態に応じて、プロファイル内のgenitalsTorsoフォルダを装着または取り外します。",
        }
    },
    accessory:{
...
// Module Locking
    ...
    bom:{},
    autoGroup:{
        isDefault: "デフォルトのグループですか？",
        tooltip:{
            isDefault: "リージョンに何も設定されていない場合に、このグループがデフォルトのグループとして使用されるかどうかを切り替えます。",    
        }
    },
    relay:{
    ...
    permissions:{
        ...
        blocklist:{
            ...
            blocklist: "ブロックリスト",
            placeholders:{
                addBlocklistUUID: "あなたのブロックリストにつかしたＵＵＩＤ…",
            }
        },
        ownerlist:{
            header: "所有者リスト",
            ownerlist: "所有者リスト",
            placeholders:{
                addOwnerUUID: "あなたの所有者に追加したいＵＵＩＤ…",
            }
        },
        apiList:{
            header: "ＡＰＩリスト",
    ...
    settings:{
        ...
        checkbox:{
            ...
            defaultNavState:        "ホームにナビゲートされたときのデフォルトの状態。",
            defaultActiveCardState: "アクティブなカードのデフォルトの状態。",
            defaultDollState:       "インタラクトドールのデフォルトの状態。",
            showAfk:                "ＡＦＫのオーバーレイを表示しますか？",
            autoGroup_power:        "テレポート時にグループを自動変更しますか？",
            linkOnCreate:           "新しく作成されたエントリを自動リンクしますか？",
            isOldAccessory:         "古いアクセサリフォルダを使用しますか？",
            isOldHair:              "古い髪型フォルダを使用しますか？",
            isOldShoe:              "古い靴フォルダを使用しますか？",
            autoGroup_useNone:      "デフォルトではアクティブなグループは存在しません。",
            ...
            defaultTempHudState:    "一時的なＨＵＤのデフォルトの状態。",
        ...
        tooltip:{
            ...
            shoeReplaceFeet:        "ＨＵＤがアウトフィットの足の状態に合わせて靴を自動的に取り付けたり取り外したりするかどうかを切り替えます。",
            playOutfitAnimations:   "アウトフィットやその状態を変更したときにＨＵＤでアニメーションを再生するかどうかを切り替えます。",
            playOutfitSounds:       "アウトフィットやその状態を変更したときにＨＵＤでサウンドを再生するかどうかを切り替えます。",
            ...
            // Temp HUDs
            isOldAccessory:         "更新されたフォルダー構造を使用するようにアクセサリモジュールを変更するには、永続的に切り替えます。",
            isOldHair:              "更新されたフォルダー構造を使用するように髪型モジュールを変更するには、永続的に切り替えます。",
            isOldShoe:              "更新されたフォルダー構造を使用するように靴モジュールを変更するには、永続的に切り替えます。.",            
            jasx_bareAutoDress:     "Bareゲーム後にＨＵＤを自動的に装着するかどうかを切り替えます。",
            autoCreateFolders:      "ＨＵＤがプロファイル、衣装などの新しく作成されたエントリのフォルダーを自動的に作成するかどうかを切り替えます。",
        },
        color:{
            colorHeader: "カラー設定",
            categoryPreset:{
